# Contributing to Move Auditor Skills
...
- **Attack vectors** - add new vectors to `move-auditor/references/attack-vectors/attack-vectors-*.md` following the existing local format.
